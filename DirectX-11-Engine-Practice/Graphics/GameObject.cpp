...
const XMVECTOR& GameObject::GetForwardVector() const
{
	return this->vec_forward;
}

const XMVECTOR& GameObject::GetRightVector() const
{
	return this->vec_right;
}

const XMVECTOR& GameObject::GetBackwardVector() const
{
	return this->vec_backward;
}

const XMVECTOR& GameObject::GetLeftVector() const
{
